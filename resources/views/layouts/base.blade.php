...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="Fashionista">
        ...
        <ul>
            ...
            @endif
                            ...
                            <div class="search-full">
                                <form method="GET" class="search-full" action="http://localhost:8080/search">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>Phone:</b> <span class="font-light"> +84 098999999</span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light"> HN, Ho Tung Mau, VIETNAM</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> contact@fashionista.in</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2024, Fashionista .</p>
                    </div>
                </div>
            </div>
        </div>
